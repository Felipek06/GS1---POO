...
public class SensorPressao extends ComponenteEspacial implements Sensor {
    ...
    public SensorPressao(String id, double limiteMinimo, double limiteAlerta) {
        super(id, "Sensor de Pressão", 22.0);
    ...
    public double lerValor() {
        valorAtual = limiteMinimo + (random.nextDouble() * (limiteAlerta - limiteMinimo + 20));
