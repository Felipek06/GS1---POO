...
public class SensorRadiacao extends ComponenteEspacial implements Sensor {
    ...
    public SensorRadiacao(String id, double limiteMinimo, double limiteAlerta) {
        super(id, "Sensor de Radiação", 18.0);
    ...
    public double lerValor() {
        valorAtual = limiteMinimo + (random.nextDouble() * (limiteAlerta - limiteMinimo + 2));
